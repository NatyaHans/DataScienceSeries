...
The stackoverflow post provided an excellent answer of the syntax differences between data frame and data table, so I highly encourage folks to read the information [on this link](https://stackoverflow.com/questions/13618488/what-you-can-do-with-a-data-frame-that-you-cant-with-a-data-table) along with the beginner's FAQs for data.table [here](https://cran.r-project.org/web/packages/data.table/vignettes/datatable-faq.html)
